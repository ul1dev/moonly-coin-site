...
export const privacyPolicyTranslations: Record<string, PrivacyPolicyTranslations> = {
  ...
  ru: {
    ...
    preamble: {
      title: "Преамбула",
      content: "Настоящая Политика конфиденциальности («Политика конфиденциальности»), вместе с нашими Условиями использования («Условия»), определяет основы сбора, использования и раскрытия личной информации о лицах, использующих платформу MoonlyCoin (далее «Сервис»), при взаимодействии с нами, заключении с нами договоров, общении с нами или иным участии в наших услугах. В ней также разъясняются меры, которые мы принимаем для защиты вашей информации. Для целей настоящей Политики конфиденциальности «Личная информация» означает любые данные, позволяющие напрямую или косвенно идентифицировать вас (например, ваше имя, контактные данные, IP-адрес или информацию, касающуюся использования вами нашего Сервиса). Мы соблюдаем Закон о защите данных 2021 года Британских Виргинских островов и, в применимой мере, законодательство других юрисдикций, включая, но не ограничиваясь, Общим регламентом защиты данных Европейского союза (далее — «GDPR»). Мы обрабатываем ваши данные законным, справедливым и прозрачным способом."
    },
    whoWeAre: {
      title: "Кто мы такие",
      content: "MoonlyCoin Ltd («Мы», «Нас» или «Наш») — компания, зарегистрированная на Британских Виргинских островах, которая управляет платформой MoonlyCoin, предоставляя услуги цифрового кошелька и проведения транзакций в блокчейне, а также каналы для вовлечения сообщества энтузиастов криптовалют. Наш юридический адрес:",
      address: "MoonlyCoin Ltd\n100 Crypto Way, Suite 400\nRoad Town, Тортола\nБританские Виргинские острова, VG1122",
      contact: "Если у вас возникнут вопросы относительно наших практик в области конфиденциальности или настоящей Политики конфиденциальности, или если вы хотите воспользоваться любыми своими правами, описанными в данном документе, пожалуйста, свяжитесь с нами по следующим контактам:",
      contactInfo: "Электронная почта: privacy@moonlycoin.com\nКонтактная страница: https://moonlycoin.com/contact"
    },
    informationWeCollect: {
    ...
    howYourInformationIsUsed: {
      ...
      content: "Мы можем использовать вашу личную информацию для следующих целей:",
      list: [
    ...
    yourRights: {
      ...
      content: "Вы обладаете рядом прав в отношении личной информации, которую мы о вас храним. Некоторые из этих прав могут иметь ограничения в зависимости от обстоятельств, а их осуществление может повлиять на нашу способность поддерживать с вами деловые отношения. Эти права включают:"
    },
    rightToConfirmation: {
      title: "Право на подтверждение",
      content: "Вы имеете право получить подтверждение о том, что ваша личная информация обрабатывается нами. Чтобы воспользоваться этим правом, пожалуйста, свяжитесь с нами, как указано в разделе 1."
    },
    rightToAccess: {
      title: "Право на доступ",
      content: "Вы имеете право в любое время получить доступ к вашей личной информации, находящейся у нас, и получить её копию. Это включает следующую информацию:",
      list: [
        "Цели, для которых обрабатывается ваша информация;",
        "Категории обрабатываемой личной информации;",
        "Получатели или категории получателей, которым ваша информация уже передавалась или будет передана;",
      ...
      additionalContent: "Чтобы воспользоваться правом доступа, пожалуйста, свяжитесь с нами, как указано в разделе 1."
    },
    rightToRectification: {
      title: "Право на исправление",
      content: "Вы имеете право требовать незамедлительного исправления недостоверной личной информации о вас. Вы также имеете право дополнить неполную информацию, предоставив дополнительное заявление. Для реализации этого права, пожалуйста, свяжитесь с нами, как указано в разделе 1."
    },
    rightToErasure: {
      title: "Право на удаление (право быть забытым)",
      content: "Вы имеете право требовать без неоправданных задержек удаления вашей личной информации, если:",
      list: [
      ...
      additionalContent: "Чтобы потребовать удаление информации, пожалуйста, свяжитесь с нами, как указано в разделе 1."
    },
    rightToRestriction: {
      ...
      additionalContent: "Если любое из этих условий применимо и вы хотите потребовать ограничение обработки, пожалуйста, свяжитесь с нами."
    },
    rightToObject: {
    ...
    rightToDataPortability: {
      ...
      content: "Вы имеете право получить личную информацию, которую вы предоставили нам, в структурированном, общепринятом и машиночитаемом формате. Вы также имеете право передать эти данные другому оператору без препятствий с нашей стороны, при условии, что обработка основана на согласии или договоре и осуществляется с использованием автоматизированных средств. Если это технически возможно и не нарушает права и свободы других лиц, вы можете также потребовать, чтобы ваша личная информация была передана напрямую от одного оператора другому. Чтобы воспользоваться правом на переносимость данных, пожалуйста, свяжитесь с нами."
    },
    automatedDecisionMaking: {
      ...
      additionalContent: "Хотя в настоящее время мы используем профилирование только для адаптации наших коммуникаций и услуг к вашим интересам, если вы хотите воспользоваться своими правами в отношении автоматизированного принятия решений, пожалуйста, свяжитесь с нами."
    },
    rightToWithdrawConsent: {
      title: "Право отозвать согласие на обработку персональных данных",
      content: "Вы имеете право в любое время отозвать свое согласие на обработку вашей личной информации. Чтобы воспользоваться этим правом, пожалуйста, свяжитесь с нами."
    },
    manifestlyUnfoundedRequests: {
      title: "Право, если запросы кажутся явно необоснованными или чрезмерными",
      content: "Хотя вы можете осуществлять свои права бесплатно, мы оставляем за собой право взимать разумную плату за запросы, которые являются явно необоснованными или чрезмерными. В таких случаях мы также можем отказать в удовлетворении запроса."
    },
    marketingPreferences: {
      content: "Кроме того, вы имеете право указать нам не обрабатывать вашу личную информацию в маркетинговых целях. Вы можете воспользоваться этим правом, изменив свои настройки в формах сбора данных или связавшись с нами через нашу контактную страницу. Мы не будем обращаться к вам с маркетинговыми предложениями, если вы предварительно не дали согласия, и вы можете изменить свои маркетинговые предпочтения в любое время."
    },
    updateInformation: {
      title: "Как вы можете обновить свою информацию",
      content: "Для нас важна точность вашей информации. Если вам необходимо обновить или исправить ваши личные данные, пожалуйста, свяжитесь с нами по адресу:",
      contactInfo: "Электронная почта: update@moonlycoin.com",
      additionalContent: "или обновите свои данные непосредственно в настройках вашего аккаунта на платформе MoonlyCoin."
    },
    securityMeasures: {
      title: "Меры безопасности для защиты вашей информации",
      content: "Когда вы предоставляете нам личную информацию, мы принимаем меры для обеспечения её безопасной обработки. Безопасность вашей личной информации имеет первостепенное значение для MoonlyCoin Ltd. Мы внедрили соответствующие физические, электронные и организационные процедуры для защиты личной информации, собранной через наш Сервис, и обеспечения её целостности и конфиденциальности. Несмотря на наши усилия по защите вашей информации, обратите внимание, что неконфиденциальные данные (например, ваш адрес электронной почты) могут передаваться в незашифрованном виде через Интернет, и ни один способ передачи не является абсолютно безопасным. Вы передаете свою информацию на свой страх и риск, и после её получения мы применяем надежные меры безопасности для защиты данных."
    },
    profiling: {
      title: "Профилирование",
      content: "Мы можем анализировать вашу личную информацию для создания профиля ваших предпочтений и интересов, чтобы предоставлять вам персонализированную информацию и рекомендации по нашим продуктам и услугам. Мы также можем дополнять этот профиль дополнительной информацией из внешних источников для улучшения наших сервисов."
    },
    useOfCookies: {
    ...
    strictlyNecessaryCookies: {
      content: "Файлы cookie, строго необходимые для работы Сервиса: эти файлы cookie необходимы для корректного функционирования Сервиса и не могут быть отключены в наших системах. Они, как правило, устанавливаются в ответ на действия, которые вы предпринимаете (например, установление ваших предпочтений конфиденциальности, вход в систему или заполнение форм) и обеспечивают базовые функции, такие как навигация по страницам и доступ к защищенным разделам Сервиса."
    },
    linksToOtherSites: {
      title: "Ссылки на другие веб-сайты, приложения или мини-приложения",
      content: "Наш Сервис может содержать ссылки на другие веб-сайты, приложения или мини-приложения, управляемые третьими сторонами. Настоящая Политика конфиденциальности применяется исключительно к нашему Сервису. Мы рекомендуем вам ознакомиться с политиками конфиденциальности любых других веб-сайтов, приложений или мини-приложений, к которым вы получаете доступ через ссылки с нашего Сервиса. Мы не несем ответственности за практики конфиденциальности этих третьих сторон."
    },
    ifYouAreUnder18: {
      title: "Если вам меньше 18 лет",
      content: "Мы привержены защите конфиденциальности детей. Если вам меньше 18 лет, пожалуйста, получите разрешение от вашего родителя или опекуна перед предоставлением какой-либо личной информации или использованием нашего Сервиса."
    },
    whereWeStoreInformation: {
      title: "Где мы храним вашу личную информацию",
      content: "Данные, которые мы собираем о вас, могут передаваться, храниться и обрабатываться в странах, отличных от Британских Виргинских островов. В таких случаях местное законодательство о защите данных может отличаться от законодательства Британских Виргинских островов. Мы осуществляем передачу данных только в случае необходимости для исполнения договора, для защиты или осуществления правовых требований, на основании вашего явного согласия или при наличии соответствующих мер защиты (например, стандартных договорных оговорок, одобренных соответствующими органами). Хотя мы предпринимаем разумные меры для защиты вашей личной информации при передаче и хранении, Интернет не является полностью безопасным, и любая передача осуществляется на ваш страх и риск. После получения вашей информации мы применяем строгие процедуры и меры безопасности для предотвращения несанкционированного доступа."
    },
    miscellaneous: {
      title: "Разное",
      content: "Если какая-либо часть настоящей Политики конфиденциальности будет признана недействительной, незаконной или не имеющей силы судом или компетентным органом, эта часть (или соответствующая ее часть) будет считаться удаленной в минимально необходимом объеме и не повлияет на действительность или исполнимость оставшихся положений. Если иное не оговорено, задержка или бездействие при осуществлении какого-либо права или средства защиты не будет считаться отказом от этого права или средства защиты. Все вопросы, касающиеся настоящей Политики конфиденциальности, а также любые споры, возникающие из нее (включая споры, не основанные на договоре), регулируются и толкуются в соответствии с законодательством Британских Виргинских островов, без учета коллизионных норм. Любые судебные разбирательства, возникающие в связи с настоящей Политикой конфиденциальности, должны вестись исключительно в судах Британских Виргинских островов, хотя мы оставляем за собой право возбуждать судебные иски или претензии за нарушение этих Условий в вашей стране проживания или в другой соответствующей юрисдикции. Вы отказываетесь от любых возражений по поводу юрисдикции или места рассмотрения таких дел."
    },
    updatingPolicy: {
      title: "Обновление и изменение настоящей Политики конфиденциальности",
      content: "В связи с постоянным развитием нашего Сервиса и изменениями в законодательных или нормативных требованиях, мы можем время от времени обновлять настоящую Политику конфиденциальности. Продолжение использования нашего Сервиса после публикации изменений означает ваше согласие с пересмотренной Политикой конфиденциальности."
    },
