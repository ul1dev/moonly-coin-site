...
export const privacyPolicyTranslations: Record<string, PrivacyPolicyTranslations> = {
  ...
  ru: {
    ...
    linksToOtherSites: {
      ...
      content: "Наш Сервис может содержать ссылки на другие веб-сайты, приложения или мини-приложения, управляемые третьими сторонами. Настоящая Политика конфиденциальности применяется исключительно к нашему Сервису. Мы рекомендуем вам ознакомиться с политиками конфиденциальности любых других
