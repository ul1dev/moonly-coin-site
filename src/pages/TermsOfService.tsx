            ...
            >
                <div className="max-w-4xl mx-auto prose prose-invert">
                    ...
                    <h2 className="text-xl font-semibold text-primary mb-4">
                        {language === 'en' ? 'Preamble' : 'Преамбула'}
                    </h2>
                    ...
                    <h2 className="text-xl font-semibold text-primary mb-4">
                        {language === 'en' ? 'About the Service' : 'О Сервисе'}
                    </h2>
                    <p className="text-gray-300 mb-6">
                        {language === 'en'
                    ...
                    <ul className="list-disc pl-6 text-gray-300 mb-6">
                        {language === 'en' ? (
                            <>
                                <li>
                                    You have the authority and legal capacity to
                                    enter into these Terms.
                                </li>
                                <li>
                                    Your use of the Service does not violate the
                                    laws of your country of residence or
                                    citizenship.
                                </li>
                                <li>
                                    You are using the Service solely for
                            ...
                            <>
                                <li>
                                    У вас есть полномочия и правоспособность для
                                    заключения этих Условий.
                                </li>
                                <li>
                                    Ваше использование Сервиса не нарушает
                                    законы вашей страны проживания или
                                    гражданства.
                                </li>
                                <li>
                                    Вы используете Сервис исключительно для
                    ...
                    <ul className="list-disc pl-6 text-gray-300 mb-6">
                        {language === 'en' ? (
                            <>
                                <li>
                                    Distributing materials that promote illegal
                                    activities, violence, extremism, or racial,
                                    religious, or ethnic hatred.
                                </li>
                                <li>
                                    Publishing content that is pornographic,
                                    offensive, obscene, or otherwise
                                    unacceptable.
                                </li>
                                <li>
                                    Disseminating instructions or information
                                    that facilitate the commission of criminal
                                    acts.
                                </li>
                                <li>
                                ...
                                <li>
                                    Using automated means (such as scraping,
                                    bots, etc.) to extract or copy the content
                                    of the Service without our written
                                    permission.
                                </li>
                                <li>
                                    Circumventing or violating any security
                                    measures implemented to protect the Service.
                                </li>
                            </>
                        ) : (
                            <>
                                <li>
                                    Распространения материалов, которые
                                    пропагандируют незаконные действия, насилие,
                                    экстремизм или расовую, религиозную или
                                    этническую ненависть.
                                </li>
                                <li>
                                    Публикации контента, который является
                                    порнографическим, оскорбительным,
                                    непристойным или иным образом неприемлемым.
                                </li>
                                <li>
                                    Распространения инструкций или информации,
                                    которые способствуют совершению преступных
                                    действий.
                                </li>
                                <li>
                                    Нарушения прав других лиц или требований
                                    закона (включая публикацию конфиденциальной
                                    информации, государственных секретов или
                                    коммерческих тайн).
                                </li>
                                <li>
                                    Использования автоматизированных средств
                                    (таких как скрейпинг, боты и т. д.) для
                                    извлечения или копирования контента Сервиса
                                    без нашего письменного разрешения.
                                </li>
                                <li>
                                    Обхода или нарушения любых мер безопасности,
                                    внедренных для защиты Сервиса.
                                </li>
                            </>
                        )}
                    </ul>
                        ...
                        {language === 'en' ? (
                            <>
                                <li>
                                    ...
                                    publishing, or otherwise using any materials
                                    from the Service.
                                </li>
                                <li>
                                    Reverse engineering, decompiling, or
                                    otherwise attempting to extract the source
                                    code or architecture of the Service.
                                </li>
                            </>
                        ) : (
                            <>
                                ...
                                <li>
                                    Обратная разработка, декомпиляция или иные
                                    попытки извлечь исходный код или архитектуру
                                    Сервиса.
                                </li>
                            </>
                        )}
                    ...
                    <ul className="list-disc pl-6 text-gray-300 mb-6">
                        {language === 'en' ? (
                            <>
                                <li>
                                    The Service will operate without failures,
                                    errors, or interruptions.
                                </li>
                                <li>
                                    The information and materials provided
                                    through the Service are accurate, complete,
                                    and up-to-date.
                                </li>
                                <li>
                            ...
                            <>
                                <li>
                                    Сервис будет работать без сбоев, ошибок или
                                    перерывов.
                                </li>
                                <li>
                                    Информация и материалы, предоставляемые
                                    через Сервис, являются точными, полными и
                                    актуальными.
                                </li>
                                <li>
                                    Сервис будет соответствовать вашим ожиданиям
                                    или требованиям.
                                </li>
                            </>
                        )}
                    ...
                    <ul className="list-disc pl-6 text-gray-300 mb-6">
                        {language === 'en' ? (
                            <>
                                ...
                                <li>
                                    Disclose information about you if necessary
                                    for an investigation or to protect our
                                    rights.
                                </li>
                                <li>
                                    Take any other actions permitted by law,
                                    including initiating legal proceedings.
                                </li>
                            </>
                        ) : (
                            <>
                                <li>
                                    Приостановить или прекратить ваш доступ к
                                    Сервису.
                                </li>
                                <li>
                                    Раскрыть информацию о вас, если это
                                    необходимо для расследования или для защиты
                                    наших прав.
                                </li>
                                <li>
                                    Принять любые другие действия, разрешенные
                                    законом, включая возбуждение судебных
                                    разбирательств.
                                </li>
                            </>
                        )}
