...
import { disclaimerTranslations } from "@/locales/disclaimer";
...
const Disclaimer = () => {
  ...
  const toggleLanguage = () => {
    ...
    setLanguage(newLang);
    navigate(`/${newLang}/disclaimer`);
  };

  const t = disclaimerTranslations[language];
    ...
    <div className="min-h-screen bg-[#0A0A0F] text-white flex flex-col">
      ...
      >
        <div className="max-w-4xl mx-auto prose prose-invert">
          ...
          <PolicySection content={t.introduction.content} className="mb-8" />
          
          <PolicySection {...t.volatilityRisk} className="mb-8" />
          <PolicySection {...t.regulatoryRisks} className="mb-8" />
          <PolicySection {...t.technologicalRisks} className="mb-8" />
          <PolicySection {...t.marketRisks} className="mb-8" />
          <PolicySection {...t.investmentRisks} className="mb-8" />
          
          <PolicySection content={t.conclusion.content} className="mt-8 pt-8 border-t border-primary/10" />
        </div>
      </motion.div>
